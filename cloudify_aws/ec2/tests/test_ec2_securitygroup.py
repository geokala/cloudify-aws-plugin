...
class TestSecurityGroup(testtools.TestCase):
    ...
    @mock.patch('cloudify_aws.ec2.securitygroup.SecurityGroup._get_security_group_from_name')
    def test_get_security_group_from_name(self, *_):
        ...
        with mock_ec2():
            with mock.patch('cloudify_aws.ec2.securitygroup.SecurityGroup.__init__') as mock_sg_init:
                with mock.patch('cloudify_aws.ec2.securitygroup.SecurityGroup._get_security_group_from_name') as mock_get_sg:
                    ...
                    ctx.instance.runtime_properties['aws_resource_id'] = group.id
                    output = securitygroup.SecurityGroup()._get_security_group_from_name(
                            group.id)
    ...
    def test_create_external_securitygroup_not_external(self):
        ...
        output = test_securitygroup._create_external_securitygroup(
                name)
    ...
    def test_delete_external_securitygroup_not_external(self):
        ...
        output = test_securitygroup._delete_external_securitygroup()
        self.assertEqual(False, output)
