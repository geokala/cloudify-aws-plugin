...
class TestElasticIP(testtools.TestCase):
    ...
    def test_allocate(self):
        ...
        elasticip.ElasticIP().allocate(ctx=ctx)
    ...
    def test_release_external_elasticip(self):
        ...
        output = \
            test_elasticip._release_external_elasticip()
    ...
    def test_allocate_external_elasticip(self):
        ...
        output = \
            test_elasticip._allocate_external_elasticip()
    ...
    def test_good_address_release(self):
        ...
        elasticip.ElasticIP().release(ctx=ctx)
    ...
    def test_bad_address_release(self):
        ...
        ex = self.assertRaises(
                NonRecoverableError, elasticip.ElasticIP().release, ctx=ctx)
        self.assertIn(
    ...
    def test_bad_address_external_resource(self):
        ...
        ctx.node.properties['resource_id'] = '127.0.0.1'
        ex = self.assertRaises(
                NonRecoverableError, elasticip.ElasticIP().allocate, ctx=ctx)
        self.assertIn(
